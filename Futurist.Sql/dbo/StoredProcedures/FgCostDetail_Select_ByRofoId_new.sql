...
-- =============================================
CREATE PROCEDURE [dbo].[FgCostDetail_Select_ByRofoId_new]
	@RofoId int = 61139
AS
BEGIN
	SET NOCOUNT ON;
	...
	SELECT RofoId,Room,ProductId,ProductName,RofoDate,QtyRofo,ItemId,ItemName
		,[Group Substitusi],ItemAllocatedId,ItemAllocatedName,[InventBatch]
		,Qty,Price,RmPrice,PmPrice,StdCostPrice,[Source],RefId,LatestPrice 
		FROM @Result 
