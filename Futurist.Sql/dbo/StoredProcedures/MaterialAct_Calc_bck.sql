...
-- =============================================
CREATE PROCEDURE [dbo].[MaterialAct_Calc_bck]
@Year int = 2025,
@Month int = 7		
AS
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				INSERT INTO @Result([Year],[Month],ItemId,[Source],ActQty,ActPrice)
					SELECT @Year
						,@Month
						,a.ItemId 
	...
	INSERT INTO [MaterialAct] ([Year],[Month],[ItemId],[Source],[ActQty],[ActPrice])	
		SELECT [Year]
		  ,[Month]
		  ,[ItemId]
		  ,[Source]
