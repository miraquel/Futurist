...
-- Duration   : <17 menit>
-- =============================================
CREATE PROCEDURE [dbo].[ForecastingRegresi_bck]
AS
BEGIN
	...
	INSERT INTO @Item (ItemId,PurchUnit) 
		SELECT DISTINCT ItemId,PurchUnit
	...
	INSERT INTO [PurchaseForecastPrice] (ItemId,PurchUnit,InventUnit,DateTrans)
		SELECT a.ItemId, a.PurchUnit, b.UNITID, c.DateTrans
		FROM @Item a
