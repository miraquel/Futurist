...
-- =============================================
CREATE PROCEDURE [dbo].[MupCalcRoom]
@Room int = 5
AS
BEGIN
	SET NOCOUNT ON;
	...
	INSERT INTO [RofoRoom] ([Room],[RofoDate],[ItemId],[ItemName],[Qty],[QtyRem],[SalesPrice],[CreatedBy],[CreatedDate],[RecId])
		SELECT [Room],[RofoDate],[ItemId],[ItemName],[Qty],[QtyRem],[SalesPrice],[CreatedBy],[CreatedDate],[RecId]
	...
	UPDATE [ItemTrans] 
		...
		WHERE Room = @Room AND (LEFT(ItemId,1) = '1' OR LEFT(ItemId,1) = '2') --ditambahkan karena ada case Tepung F09 dimana ID 1 dan 2 merupakan substitusi
