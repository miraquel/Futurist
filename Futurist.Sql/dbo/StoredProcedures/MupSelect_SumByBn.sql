...
-- =============================================
CREATE PROCEDURE [dbo].[MupSelect_SumByBn]
	@Room int = 1
AS
BEGIN
	SELECT a.Room
	...
	GROUP BY a.Room,c.MupDate,a.[Source],s.VtaMpSubstitusiGroupId,g.[Group01],a.ItemId,i.SEARCHNAME,i.UnitId,a.InventBatch
