...
-- Durasi: 2 detik
-- =============================================
CREATE PROCEDURE [dbo].[ItemForecastRoom_UploadSelect]
	@Room int=5
AS
BEGIN
	...
	LEFT JOIN [ItemForecastRoom] f WITH (NOLOCK) ON f.ItemId = d.ItemId AND f.ForecastDate = a.RofoDate AND f.Room = a.Room
